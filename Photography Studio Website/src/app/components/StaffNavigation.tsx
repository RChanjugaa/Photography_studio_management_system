...
import { User, Briefcase, LogOut, Menu, X, Home } from 'lucide-react';
...
export default function StaffNavigation() {
  ...
  const navItems = [
    { path: '/staff/me', label: 'My Portal', icon: User },
    { path: '/employees', label: 'Team Directory', icon: Briefcase },
    { path: '/', label: 'Main Site', icon: Home },
  ];
    ...
    <nav className="bg-gradient-to-r from-black to-[#1a0505] border-b-2 border-red-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          {/* Logo */}
          <Link to="/staff/me" className="flex items-center gap-3">
