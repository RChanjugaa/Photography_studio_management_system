        ...
        >
          <Card className="p-8 bg-gradient-to-br from-[#2a0f0f] to-black border-2 border-gray-800 shadow-2xl">
            <div className="text-center mb-8">
              ...
              <h1 className="text-3xl font-serif text-yellow-500 mb-2 uppercase">Admin Portal</h1>
            ...
            <div className="mt-8 text-center">
              <p className="text-xs text-gray-500">
                Administrators only. Unauthorized access is prohibited.
              </p>
            </div>
          </Card>
        </motion.div>
