...
export const bookingsAPI = {
  ...
  getBookedSlots: (date: string) => apiCall(`/bookings/booked-slots/${date}`),
};
...
export const packagesAPI = {
  ...
  getActive: () => apiCall('/packages/active'),
  create: (data: any) => apiCall('/packages', 'POST', data),
  update: (id: number, data: any) => apiCall(`/packages/${id}`, 'PUT', data),
  delete: (id: number) => apiCall(`/packages/${id}`, 'DELETE'),
};